...
import PopularShows from "./PopularShows.vue";
...
describe("PopularShows.vue", () => {
  ...
  test("should filter shows by genre", () => {
    ...
    expect(wrapper.vm.filterShowsGenre(false)[0].genres.includes("Romance"))
      .toBeTruthy;
    expect(wrapper.vm.filterShowsGenre(false)[1].genres.includes("Romance"))
      .toBeTruthy;
  });
});
